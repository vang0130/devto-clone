        ...
        <div className="fixed inset-0 z-40 bg-black bg-opacity-50">
          <div className="absolute left-0 top-0 h-full w-[300px] items-center overflow-scroll bg-white">
            <header className="align-center flex h-[56px] w-full flex-row items-center px-4">
              <p className="justify-start text-lg font-bold">DEV Community</p>
              ...
              <nav className="mb-4 flex min-h-[600px] flex-col text-sm">
                <ul className="min-h-[40px]">
                  <li className="min-h-[40px]">
                    <a className="flex items-center p-2 text-base">
                      <span className="mr-2">
                        <svg
          ...
          `}
              ...
              <div className="mb-4 flex flex-row justify-start">
                ...
                >
                  ...
                  >
                    <title id="a5yjbdsnw8pe2omphqv5fsbqndcdek7y">
                      Facebook
                    </title>
                ...
                <a
                  className="h-[40px] w-[40px] p-2"
                  href="https://www.github.com/forem"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                >
                  ...
                  >
                    <title id="a7kcvdde9icv2hbd1npti8h7awnucmr7">
                      Instagram
                    </title>
                ...
                >
                  ...
                  >
                    <title id="ap9g3nd9m6i0w77n36iv0vva2gbzmapu">
                      Mastodon
                    </title>
